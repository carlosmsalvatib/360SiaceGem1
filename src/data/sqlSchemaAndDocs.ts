...
CREATE TABLE \`usuarios\` (
  ...
  \`avatar_origen\` ENUM('ARCHIVO_LOCAL', 'URL_EXTERNA', 'BANCO_SIAH', 'AVATAR_GENERADO', 'CAMARA_DIRECTA') DEFAULT 'URL_EXTERNA' COMMENT 'Origen del recurso de avatar',
...
CREATE TABLE \`profesionales\` (
  ...
  \`foto_origen\` ENUM('ARCHIVO_LOCAL', 'URL_EXTERNA', 'BANCO_SIAH', 'AVATAR_GENERADO', 'CAMARA_DIRECTA') DEFAULT 'URL_EXTERNA' COMMENT 'Origen de la foto del especialista',
